...
public class ledControl extends ActionBarActivity{
    ...
    private double clon;
    private double clat;
    private double handilat = 0;
    private double handilon = 0;
    private int ii = 0;
    ...
    public void locate(double cwlat,double cwlon) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
            ...
            lastLocation.distanceBetween(lat,lon,cwlat+handilat,cwlon+handilon,f1);
            double dd = f1[0]*3.28;
