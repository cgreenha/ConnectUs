...
#define BR0_FOR_4800 0x11    // Value required to use 4800 baud
...
int main(void)
{
    ...
    TA0CTL = ACLK | UP;
    motorState(0);
    TA0CCR0 = 0x0000; // do not start counting yet
...
void select_clock_signals(void)
{
	 ...
	 CSCTL1 = 0x0000; // run frequency at 1 MHz// 0x0046; // Specifies frequency of main clock
